...
import Modelo.DAO.DAO__Actividad;
...
public class ServletCargaMActividades extends HttpServlet {
 private DAO__Empresa dao_emp;
    ...
    public ServletCargaMActividades() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Actividad> obs = new ArrayList<>();
