...
import Modelo.DAO.DAO__Categoria;
import Modelo.DAO.DAO__Servidor;
...
public class ServletServidoresCategorias extends HttpServlet {
    ...
    public JSONObject obtenerServidores() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException, JSONException {
        DAO__Servidor daoSer = new DAO__Servidor();
        List<Servidor> servidores = daoSer.Obtener();
        JSONObject ob = new JSONObject();
        JSONArray matrix = new JSONArray();
    ...
    public JSONObject obtenerCategorias() throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException, JSONException {
        DAO__Categoria daoCat = new DAO__Categoria();
