                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <div class="body">
                                    <h2>Seleccione la sede</h2><br>
                                    <select style="width: 100px" class="form-control show-tick">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="body">
                                                <div class="table-responsive">
                                                    ...
                                                    <div align="center">
                                                        <button type="button" style="width: 140px" class="btn bg-teal btn-block waves-effect">Asignar
                                                            Turnos</button>
                                                    </div>
                                                </div>
                                            </div>
